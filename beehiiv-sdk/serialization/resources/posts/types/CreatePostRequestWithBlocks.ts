...
export const CreatePostRequestWithBlocks: core.serialization.ObjectSchema<
    serializers.CreatePostRequestWithBlocks.Raw,
    Beehiiv.CreatePostRequestWithBlocks
...
export declare namespace CreatePostRequestWithBlocks {
    interface Raw {
        blocks: Block.Raw[];
        title: string;
