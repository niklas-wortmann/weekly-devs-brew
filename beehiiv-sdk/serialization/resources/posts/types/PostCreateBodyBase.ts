...
export const PostCreateBodyBase: core.serialization.ObjectSchema<
    serializers.PostCreateBodyBase.Raw,
    Beehiiv.PostCreateBodyBase
...
export declare namespace PostCreateBodyBase {
    interface Raw {
        title: string;
